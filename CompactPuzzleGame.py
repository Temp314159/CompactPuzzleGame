...
pygame.display.set_caption('Compact Puzzle Game')
...
def show_rules():
    ...
    contents = [
        ('text', "Welcome to Compact Puzzle Game!"),
        
        ('image', os.path.join(work_folder, 'pictures', 'rules_cover.png'), "center"),
        
        ('text', "BASIC CONTROLS:"),
        ('text', "• Left-Click and drag to select grid cells"),
        ('text', "• Right-Click and drag to clear grid cells"),
        ('text', "• Press 'Create' to create a puzzle piece"),  # \nfrom selected cells
        ('text', "• Left-click and drag to move a piece"),
        ('text', "• Press 'Delete' to remove a piece"),
        ('text', "• Press 'Complete' to finish the game"),

        ('text', ""),

        ('text', "GAME OBJECTIVE:"),
        ('text', "Create a stable structure \nwhere all pieces can move as a single unit \nwithout falling apart."),
